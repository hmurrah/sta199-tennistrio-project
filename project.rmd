...
Here we are separating the wines by expensive (>= $200) and cheap (<= $10) for our analysis. 

The words tannins, red, black, ripe, and berry did not show any obvious differences in frequency between the two categories, but they are present in both expensive and cheap wines. Acidity was present in all wines, but was most common descriptor for cheaper wines by a fair margin. Moreover, categories have the word red fairly often (presumably referencing red wine) and we know from our top wine varieties that red wine tends to be rated more highly. We expected the cheap wines to reference white more often, however this was not the case.
...
>>>>>>> 9420243d591992e7922d13163e493df3339c8d06
