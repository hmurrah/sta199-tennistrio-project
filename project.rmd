...
ggplot(data = top_var, mapping = aes(points)) + 
  geom_density() + 
  facet_wrap(~variety) +
  labs(x = "Points", y = "Density", title = "Grüner Veltiner has a relatively concentrated density between 85 and 90 points")
...
points to bring up: austria is the best. more expensive wines are better up to a point (need to determine this point, use a linear model)
  ...
  The density plots for price and points further evidence Austria as a source of better wine. Austria clearly has a larger proportion of higher rated wines than the other top 5 countries yet at similar price ranges. Also, the wines for the top countries all show similar price distributions. Because of less variation between price in these top countries, we can make a stronger conclusion that these differences in point values represent differences percieved wine quality in among similar wines.
  
** write portion here about top varieties, note that the top varieties are from the top countries

  
  In addition to the calculation of the top countries and varieties, the linear models for predicted price both give evidence for a positive strong relationship between price and points. The linear model with top countries and top variety factors gave p values of 5.56e-21 and 1.63e-56, respectively. At an alpha level of 0.05, this gives strong evidence against a null hypothesis which is that there is no relationship between being in the top variety or country and the point value.
