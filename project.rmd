...
Gewürztraminer, Pinot Gris, Pinot Noir, and Riesling varieties show more evenly distributed point values for wines whereas Grüner Veltliner's data distribution is concentrated around the 90 point value. Unlike with Austria, however, this larger density of wines around the 90 point value did not make the Grüner Veltliner the variety with the best average point value.
...
The density plots for the top five varieties and top five countries all look generally right skewed and most of the wines are less than 100 dollars. One noticeable difference is that both Austria and the Gruner Veltliner variety generally have cheaper wines compared to the other top varieties or countries.
