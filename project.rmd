...
Contrary to our hypothesis, Italy and France are nowhere to be seen in the top 5 or even the top 10 average scoring countries. The top 5 countries with the highest average wine score are Austria, Germany, France, US, and Italy in that order.
...
```{r weighted_wine_scores_to_price2, message = FALSE, warning = FALSE, echo = FALSE}
